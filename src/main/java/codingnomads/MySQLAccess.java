...
public class MySQLAccess {
    ...
    public void readDataBase(String course_name, int units)
        ...
        try {
            ...
            resultSet = statement.executeQuery("select * from University2.courses;");
            ...
            preparedStatement = connection
                    .prepareStatement("insert into  University2.courses (name, units) " +
                            "values (?, ?)");
           ...
           // preparedStatement.setString(2, credits);
            ...
            preparedStatement = connection
                    .prepareStatement("delete from University2.courses where name = ? ; ");
